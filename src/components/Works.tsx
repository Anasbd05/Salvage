  ...
  return (
    <section id="works" className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 ">
      <div className=" flex flex-col items-center justify-center ">
        ...
        <p className=" text-gray-600 text-sm lg:text-base lg:max-w-2xl text-center mt-4 px-6">
      ...
      <main className=" grid px-8 mt-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full ">
